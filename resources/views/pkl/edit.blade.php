                        ...
                        <form action="{{ route('pkl.update', $pkl->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <select class="from-select col-md-12" name="siswa_id" id="siswa_id" >
                                    ...
                                    <option class="col-md-12" value="{{ $siswa->id }}"  {{ $pkl->siswa_id == $siswa->id ? 'selected':'' }}> {{ $siswa->nama }}</option>
                            ...
                            <div class="form-group">
                                ...
                                <select class="from-select col-md-12" name="dudi_id" id="dudi_id">
                                    ...
                                    <option class="col-md-12" value="{{ $dudi->id }}" {{ $pkl->dudi_id == $dudi->id ? 'selected':'' }}> {{ $dudi->nama }}</option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="from-select col-md-12" name="tgl_masuk"  value="{{ $pkl->tgl_masuk }}" placeholder="">
                            </div>
                            <div class="form-group">
                                <label class="font-weight-bold">Tanggal Keluar</label>
                                <input type="date" class="from-select col-md-12" name="tgl_keluar"  value="{{ $pkl->tgl_keluar }}"placeholder="">
                            </div>
